	...
	**/
	...
	override function update(elapsed:Float)
	{
		...
		if (!blockInput)
		{
			...
			{
				autosaveSong();
				LoadingState.loadAndSwitchState(#if (flixel >= version("5.6.0")) () -> #end new editors.EditorPlayState(sectionStartTime()));
			}
